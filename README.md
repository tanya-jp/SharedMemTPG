...
To run an experiment using 4 parallel MPI processes, make alert(tpg/classic_control_example) your working directory and run:
```
tpg-run-mpi.sh -n 4
```
...
tpg-plot-stats.sh
```
This should produce a pdf named alert(classic_control_p0.pdf) with various statistics. The first page will be a training curve looking something like this:
